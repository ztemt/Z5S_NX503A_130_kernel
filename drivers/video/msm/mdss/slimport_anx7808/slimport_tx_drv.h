...
#define CHARGING_STATUS_REPORT_EN
...
extern void sp_tx_aux_polling_enable(bool benable);
...
extern unchar sp_tx_get_downstream_type(void);
...
extern unchar sp_tx_aux_dpcdwrite_bytes(unchar addrh, unchar addrm,
	unchar addrl, unchar cCount, unchar *pBuf);
unchar sp_tx_aux_dpcdread_bytes(unchar addrh, unchar addrm,
	unchar addrl, unchar cCount, unchar *pBuf);
extern void slimport_driver_version(void);
